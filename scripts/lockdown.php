...
<div style id='notify' onclick><span id='notify_title'>Admin</span><hr id='msgbr3'><img id='notify_img' width='90px' height='90px' style='display:none;'><span id='notify_text'>Disabling Surge! This action cannot be undone!</span><span id='edit-loader'></span></div>
    ...
    <script async>
                        ...
                        <script defer>
                         document.getElementById('loader').remove()
                            ...
                            <script>
setTimeout(() => {
    window.location.replace('/newsurg/home/?u=<?php echo$_GET['u']; ?>&ta=<?php echo$_GET['ta']; ?>')
}, 5000);
                                </script>
...
file_put_contents('C:/xampp/htdocs/newsurg/data/misc/surge.active','0')
