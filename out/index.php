<?php
if (isset($_GET['url']) && strpos($_GET['url'], 'https://surgeme.xyz') === 0) {
    header('Location: ' . str_replace('ANDSYMBOL','&',$_GET['url']));
    exit;
}
?>
<!DOCTYPE html>
...
<div id='left-section' class='section no-scroll-back'>
    ...
    <img alt='User Profile Picture' title='User Profile Picture' id='left-pfp' width='70px' height='70px' src='/newsurg/scripts/showpfp.php?u=<?php echo 'user'; ?>&l=0'>
    <span id='left-welcome'>Hello, </span> <a id='left-username' class='link ripple' title='Manage My Account' href='javascript:manageMyAccount();'><?php echo 'user'; ?></a>
...
<div style='display:none;' id='notify' style='display:none;' onclick><span id='notify_title'></span><hr id='msgbr3'><img id='notify_img' width='90px' height='90px' style='display:none;'><span id='notify_text'></span><span id='edit-loader'></span></div>
...
<img onclick="window.open('/newsurg/scripts/showpfp.php?l=1&u=<?php echo 'user';?>', '_blank').focus();
" alt='user profile picture' title='User Profile Picture' src='/newsurg/scripts/showpfp.php?l=1&u=<?php echo 'user';?>' width='200px' height='200px' id='mm-pfp'>
<div id='mm-pfp-effect'></div>
<span id='mm-name'><?php echo 'user';?></span>
...
<span id='vm-close' class='ripple' onclick='window.history.back()'> X </span>
<span id='vm-pfp'>!</span>
<div id='vm-pfp-effect'></div>
<span id='vm-name'>Warning</span>
<span id='vm-bio'>You are about to leave Surge!</span>
<span id='vm-info'><?php echo$_GET['url'];?></span>
<a id='a' href='#' onclick='window.history.back()'>Back to safety</a><a id='b' href='#' onclick='window.location.href="<?php echo str_replace('ANDSYMBOL','&',$_GET['url']);?>"'>Continue</a>
<span id='vm-load' style='display:none;'></span>
</div>
